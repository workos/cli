...
const paginationOpts: OptionSchema[] = [
  ...
  { name: 'before', type: 'string', description: 'Pagination cursor for results before a specific item', required: false, hidden: false },
  { name: 'after', type: 'string', description: 'Pagination cursor for results after a specific item', required: false, hidden: false },
  { name: 'order', type: 'string', description: 'Sort order (asc or desc)', required: false, choices: ['asc', 'desc'], hidden: false },
];
...
const commands: CommandSchema[] = [
  ...
  },
  {
    ...
    options: [
      { name: 'list', type: 'boolean', description: 'List available skills without installing', required: false, alias: 'l', hidden: false },
      { name: 'skill', type: 'array', description: 'Install specific skill(s) by name', required: false, alias: 's', hidden: false },
      { name: 'agent', type: 'array', description: 'Target specific agent(s): claude-code, codex, cursor, goose', required: false, alias: 'a', hidden: false },
    ],
  },
  {
    name: 'doctor',
    ...
    options: [
      { name: 'verbose', type: 'boolean', description: 'Include additional diagnostic information', required: false, default: false, hidden: false },
      { name: 'skip-api', type: 'boolean', description: 'Skip API calls (offline mode)', required: false, default: false, hidden: false },
      { name: 'skip-ai', type: 'boolean', description: 'Skip AI-powered analysis', required: false, default: false, hidden: false },
      { name: 'install-dir', type: 'string', description: 'Project directory to analyze (defaults to cwd)', required: false, hidden: false },
      { name: 'json', type: 'boolean', description: 'Output diagnostic report as JSON', required: false, default: false, hidden: false },
      { name: 'copy', type: 'boolean', description: 'Copy diagnostic report to clipboard', required: false, default: false, hidden: false },
    ],
  },
  {
    name: 'env',
    ...
    commands: [
      ...
      },
      {
        ...
        positionals: [
          { name: 'name', type: 'string', description: 'Environment name to remove', required: true },
        ],
      },
      {
        name: 'switch',
        ...
        positionals: [
          { name: 'name', type: 'string', description: 'Environment name to activate', required: false },
        ],
      },
      {
        name: 'list',
    ...
    commands: [
      {
        ...
        positionals: [
          ...
          { name: 'domains', type: 'string', description: 'Domains in format domain:state (state defaults to verified)', required: false },
        ],
      },
      {
        name: 'update',
      ...
      },
      {
        ...
        options: [
          { name: 'domain', type: 'string', description: 'Filter organizations by domain', required: false, hidden: false },
          ...paginationOpts,
        ],
      },
      {
    ...
    commands: [
      {
        ...
        positionals: [
          { name: 'userId', type: 'string', description: 'User ID (user_*)', required: true },
        ],
      },
      {
        name: 'list',
        ...
        options: [
          { name: 'email', type: 'string', description: 'Filter users by email address', required: false, hidden: false },
          { name: 'organization', type: 'string', description: 'Filter users by organization ID', required: false, hidden: false },
          ...paginationOpts,
        ],
      },
      {
        ...
        options: [
          ...
          { name: 'email-verified', type: 'boolean', description: 'Email verification status', required: false, hidden: false },
          { name: 'password', type: 'string', description: 'New password', required: false, hidden: false },
          { name: 'external-id', type: 'string', description: 'External ID for cross-system mapping', required: false, hidden: false },
        ],
      },
      {
        name: 'delete',
  ...
  },
  {
    ...
    options: [
      { name: 'direct', type: 'boolean', description: 'Use your own Anthropic API key (bypass llm-gateway)', required: false, default: false, alias: 'D', hidden: false },
      { name: 'debug', type: 'boolean', description: 'Enable verbose logging', required: false, default: false, hidden: false },
      insecureStorageOpt,
      { name: 'homepage-url', type: 'string', description: 'App homepage URL for WorkOS (defaults to http://localhost:{port})', required: false, hidden: false },
      { name: 'redirect-uri', type: 'string', description: 'Redirect URI for WorkOS callback (defaults to framework convention)', required: false, hidden: false },
      { name: 'no-validate', type: 'boolean', description: 'Skip post-installation validation (includes build check)', required: false, default: false, hidden: false },
      { name: 'install-dir', type: 'string', description: 'Directory to install WorkOS AuthKit in (defaults to cwd)', required: false, hidden: false },
      { name: 'integration', type: 'string', description: 'Framework integration to set up (auto-detected if omitted)', required: false, hidden: false },
      { name: 'force-install', type: 'boolean', description: 'Force install packages even if peer dependency checks fail', required: false, default: false, hidden: false },
      { name: 'dashboard', type: 'boolean', description: 'Run with visual dashboard mode', required: false, default: false, alias: 'd', hidden: false },
    ],
  },
];

const globalOptions: OptionSchema[] = [
  { name: 'json', type: 'boolean', description: 'Output results as JSON (auto-enabled in non-TTY environments)', required: false, default: false, hidden: false },
