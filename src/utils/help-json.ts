    ...
    commands: [
      ...
      },
      {
        ...
        commands: [
          ...
          {
            name: 'set',
            description: 'Upload AuthKit branding images (logo, icon, favicon) for an environment',
            options: [
              {
                name: 'environment-id',
                type: 'string',
            ...
            examples: ['workos authkit branding set --logo ./logo.png --icon ./icon.png --favicon ./favicon.ico'],
          },
        ],
      },
    ],
