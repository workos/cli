  ...
  const parser = yargs(rawArgs)
    ...
    .command('user', 'Manage AuthKit users (get, list, update, delete)', (yargs) => {
      ...
      registerSubcommand(
        ...
        'Get a user by ID',
        (y) =>
          y.positional('userId', { type: 'string', demandOption: true, describe: 'User ID' }).option('environment-id', {
            type: 'string',
            describe: 'Environment ID (defaults to the active environment)',
          }),
        async (argv) => {
    ...
    .command('role', 'Manage WorkOS roles (environment and organization-scoped)', (yargs) => {
      ...
      registerSubcommand(
        ...
        'Get a role by slug',
        (y) =>
          y.positional('slug', { type: 'string', demandOption: true }).option('environment-id', {
            type: 'string',
            describe: 'Environment ID (defaults to the active environment)',
          }),
        async (argv) => {
    ...
    .command('org-domain', 'Manage organization domains', (yargs) => {
      ...
      registerSubcommand(
        ...
        'Get a domain',
        (y) =>
          y.positional('id', { type: 'string', demandOption: true, describe: 'Domain ID' }).option('environment-id', {
            type: 'string',
            describe: 'Environment ID (defaults to the active environment)',
          }),
        async (argv) => {
